              ...
              <ul className="space-y-4">
                <li className="flex items-start space-x-3">
                  ...
                  <span className="text-gray-100">
                    1st floor, Sadhana Mike Supply, New The New, Rup Narayan Rd,
                ...
                <li className="flex items-center space-x-3">
                  ...
                  <a
                    href="mailto:dr.subhayandas007@gmail.com"
                    className="text-gray-100 hover:text-lime-500 transition-colors"
                  >
                    dr.subhayandas007@gmail.com
                  </a>
                </li>
              </ul>
            </div>
        ...
        <div className="bg-gray-800 py-4">
          <div className="container mx-auto px-4 flex flex-wrap items-center justify-between text-sm text-gray-400">
            <p className="text-white">
              © 2025 Dentique Multispeciality Dental Care, Coochbehar
            </p>
            {/* <p>
